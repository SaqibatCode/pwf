{{-- resources/views/dashboard/admin/sliders/create.blade.php --}}
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="another_heading" class="font-medium text-gray-700">Another Heading</label>
                             <input type="text" name="another_heading" id="another_heading" class="form-control" value="{{ old('another_heading') }}">
                        </div>
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" name="button_url" id="button_url" class="form-control @error('button_url') is-invalid @enderror" value="{{ old('button_url') }}" required>
                            @error('button_url')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="file" name="image_desktop" id="image_desktop" class="form-control-file @error('image_desktop') is-invalid @enderror" required>
                            @error('image_desktop')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            <label for="image_mobile" class="font-medium text-gray-700">Mobile Image</label>
                             <input type="file" name="image_mobile" id="image_mobile" class="form-control-file @error('image_mobile') is-invalid @enderror" required>
                            @error('image_mobile')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
