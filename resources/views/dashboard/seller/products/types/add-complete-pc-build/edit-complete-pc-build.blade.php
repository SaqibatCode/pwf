                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="product_name"
                                                value="{{ $completePc->product_name }}" id="product_name"
                                                class="form-control">
                                        </div>
                                    </div>
                                    {{-- Warranty --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="warranty" class="form-control" id="warranty">
                                                ...
                                                <option value="6 Months"
                                                    {{ $completePc->warranty == '6 Months' ? 'selected' : '' }}>6 Months
                                                </option>
                                                <option value="1 Year"
                                                    {{ $completePc->warranty == '1 Year' ? 'selected' : '' }}>1 Year
                                                </option>
                                                <option value="2 Year"
                                                    {{ $completePc->warranty == '2 Year' ? 'selected' : '' }}>2 Year
                                                </option>
                                                <option value="3 Year"
                                                    {{ $completePc->warranty == '3 Year' ? 'selected' : '' }}>3 Year
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sku" value="{{ $completePc->sku }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="process_name" class="form-label">Processor
                                                                Name</label>
                                                            <input type="text"
                                                                value="{{ $completePc->parts()->where('key', 'process_name')->value('value') }}"
                                                                name="process_name" id="processor_name"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="process_brand" id="process_brand"
                                                                ...
                                                                <!-- Dynamically populate selected value -->
                                                                @php
                                                                    $processBrand = $completePc
                                                                        ->parts()
                                                                        ->where('key', 'process_brand')
                                                                        ->value('value');
                                                                @endphp
                                                                <option value="Intel"
                                                                    {{ $processBrand == 'Intel' ? 'selected' : '' }}>Intel
                                                                </option>
                                                                <option value="AMD"
                                                                    {{ $processBrand == 'AMD' ? 'selected' : '' }}>AMD
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="process_gen_year" class="form-label">Processor
                                                                Generation Year</label>
                                                            <select name="process_gen_year" id="process_gen_year"
                                                                class="form-control">
                                                                <option value="">Select Processor Generation Year
                                                                </option>
                                                                @php
                                                                    $processGenYear = $completePc
                                                                        ->parts()
                                                                        ->where('key', 'process_gen_year')
                                                                        ->value('value');
                                                                @endphp
                                                                @foreach (range(date('Y') - 10, date('Y')) as $year)
                                                                    <option value="{{ $year }}"
                                                                        {{ $processGenYear == $year ? 'selected' : '' }}>
                                                                        {{ $year }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="process_condition" id="process_condition"
                                                                ...
                                                                @php
                                                                    $processCondition = $completePc
                                                                        ->parts()
                                                                        ->where('key', 'process_condition')
                                                                        ->value('value');
                                                                @endphp
                                                                <option value="New"
                                                                    {{ $processCondition == 'New' ? 'selected' : '' }}>New
                                                                </option>
                                                                <option value="Used"
                                                                    {{ $processCondition == 'Used' ? 'selected' : '' }}>
                                                                    Used</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="graphics_card_name" class="form-label">Graphics
                                                                Card Name</label>
                                                            <input type="text"
                                                                value="{{ $completePc->parts()->where('key', 'graphics_card_name')->value('value') }}"
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="graphics_card_brand" class="form-label">Graphics
                                                                Card Brand</label>
                                                            <select name="graphics_card_brand" id="graphics_card_brand"
                                                                class="form-control">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="motherboard_name" class="form-label">Motherboard
                                                                Name</label>
                                                            <input type="text"
                                                                value="{{ $completePc->parts()->where('key', 'motherboard_name')->value('value') }}"
                                                                name="motherboard_name" id="motherboard_name"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="motherboard_brand" id="motherboard_brand"
                                                                ...
                                                                <option value="ASUS"
                                                                    {{ $completePc->parts()->where('key', 'motherboard_brand')->value('value') == 'ASUS' ? 'selected' : '' }}>
                                                                    ASUS</option>
                                                                <option value="MSI"
                                                                    {{ $completePc->parts()->where('key', 'motherboard_brand')->value('value') == 'MSI' ? 'selected' : '' }}>
                                                                    MSI</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="motherboard_condition"
                                                                ...
                                                                <option value="">Select Condition</option>
                                                                <option value="New"
                                                                    {{ $completePc->parts()->where('key', 'motherboard_condition')->value('value') == 'New' ? 'selected' : '' }}>
                                                                    New</option>
                                                                <option value="Used"
                                                                    {{ $completePc->parts()->where('key', 'motherboard_condition')->value('value') == 'Used' ? 'selected' : '' }}>
                                                                    Used</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                value="{{ $completePc->parts()->where('key', 'ram_name')->value('value') }}"
                                                                name="ram_name" id="ram_name" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="ram_brand" id="ram_brand" class="form-control">
                                                                ...
                                                                <option value="Corsair"
                                                                    {{ $completePc->parts()->where('key', 'ram_brand')->value('value') == 'Corsair' ? 'selected' : '' }}>
                                                                    Corsair</option>
                                                                <option value="G.SKILL"
                                                                    {{ $completePc->parts()->where('key', 'ram_brand')->value('value') == 'G.SKILL' ? 'selected' : '' }}>
                                                                    G.SKILL</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="ram_memory" id="ram_memory"
                                                                ...
                                                                <option value="">Select Memory Bandwidth</option>
                                                                <option value="1GB"
                                                                    {{ $completePc->parts()->where('key', 'ram_memory')->value('value') == '1GB' ? 'selected' : '' }}>
                                                                    1GB</option>
                                                                <option value="2GB"
                                                                    {{ $completePc->parts()->where('key', 'ram_memory')->value('value') == '2GB' ? 'selected' : '' }}>
                                                                    2GB</option>
                                                                <option value="3GB"
                                                                    {{ $completePc->parts()->where('key', 'ram_memory')->value('value') == '3GB' ? 'selected' : '' }}>
                                                                    3GB</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="ram_dimm" id="ram_dimm" class="form-control">
                                                                ...
                                                                @foreach (['DDR1', 'DDR2', 'DDR3', 'DDR4', 'DDR5', 'DDR6'] as $type)
                                                                    <option value="{{ $type }}"
                                                                        {{ $completePc->parts()->where('key', 'ram_dimm')->value('value') == $type ? 'selected' : '' }}>
                                                                        {{ $type }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div id="storage-container">
                                                    @php
                                                        ...
                                                        $storageParts = $completePc
                                                            ->parts()
                                                            ->where('key', 'storage_name')
                                                            ->get();
                                                        $storageCount = $storageParts->count();
                                                    @endphp

                                                    @foreach ($storageParts as $index => $storage)
                                                        <div class="row storage" data-id="{{ $index + 1 }}"
                                                            id="storage_row_{{ $index + 1 }}">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="storage_name_{{ $index + 1 }}"
                                                                        class="form-label">Storage Device Name</label>
                                                                    <input type="text" name="storage_name[]"
                                                                        id="storage_name_{{ $index + 1 }}"
                                                                        class="form-control"
                                                                        value="{{ $storage->value ?? '' }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="storage_brand_{{ $index + 1 }}"
                                                                        class="form-label">Storage Brand</label>
                                                                    <select name="storage_brand[]"
                                                                        id="storage_brand_{{ $index + 1 }}"
                                                                        class="form-control">
                                                                        <option value="">Select Brands</option>
                                                                        <option value="Brand1"
                                                                            {{ isset($storage->value['brand']) && $storage->value['brand'] == 'Brand1' ? 'selected' : '' }}>
                                                                            Brand1</option>
                                                                        <option value="Brand2"
                                                                            {{ isset($storage->value['brand']) && $storage->value['brand'] == 'Brand2' ? 'selected' : '' }}>
                                                                            Brand2</option>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="storage_type_{{ $index + 1 }}"
                                                                        class="form-label">Storage Type</label>
                                                                    <select name="storage_type[]"
                                                                        id="storage_type_{{ $index + 1 }}"
                                                                        class="form-control">
                                                                        <option value="">Select Storage Type</option>
                                                                        <option value="NVMe"
                                                                            {{ isset($storage->value['type']) && $storage->value['type'] == 'NVMe' ? 'selected' : '' }}>
                                                                            NVMe</option>
                                                                        <option value="SSD"
                                                                            {{ isset($storage->value['type']) && $storage->value['type'] == 'SSD' ? 'selected' : '' }}>
                                                                            SSD</option>
                                                                        <option value="HDD"
                                                                            {{ isset($storage->value['type']) && $storage->value['type'] == 'HDD' ? 'selected' : '' }}>
                                                                            HDD</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label for="storage_capacity_{{ $index + 1 }}"
                                                                        class="form-label">Storage Capacity</label>
                                                                    <select name="storage_capacity[]"
                                                                        id="storage_capacity_{{ $index + 1 }}"
                                                                        class="form-control">
                                                                        <option value="">Select Storage Capacity
                                                                        </option>
                                                                        <option value="128GB"
                                                                            {{ isset($storage->value['capacity']) && $storage->value['capacity'] == '128GB' ? 'selected' : '' }}>
                                                                            128GB</option>
                                                                        <option value="256GB"
                                                                            {{ isset($storage->value['capacity']) && $storage->value['capacity'] == '256GB' ? 'selected' : '' }}>
                                                                            256GB</option>
                                                                        <option value="512GB"
                                                                            {{ isset($storage->value['capacity']) && $storage->value['capacity'] == '512GB' ? 'selected' : '' }}>
                                                                            512GB</option>
                                                                        <option value="1TB"
                                                                            {{ isset($storage->value['capacity']) && $storage->value['capacity'] == '1TB' ? 'selected' : '' }}>
                                                                            1TB</option>
                                                                        <option value="2TB"
                                                                            {{ isset($storage->value['capacity']) && $storage->value['capacity'] == '2TB' ? 'selected' : '' }}>
                                                                            2TB</option>
                                                                        <option value="3TB"
                                                                            {{ isset($storage->value['capacity']) && $storage->value['capacity'] == '3TB' ? 'selected' : '' }}>
                                                                            3TB</option>
                                                                        <option value="4TB"
                                                                            {{ isset($storage->value['capacity']) && $storage->value['capacity'] == '4TB' ? 'selected' : '' }}>
                                                                            4TB</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <!-- Button to Add More Storage (if needed) -->
                                                    @if ($storageCount < 3)
...
@section('additionScript')
    ...
    <script>
        var existingYear = "{{ $completePc->year_of_make }}";
        if (existingYear) {
            setTimeout(() => {
                $('#year').val(existingYear);
                $('#process_gen_year').val(
                    "{{ $completePc->parts()->where('key', 'process_gen_year')->value('value') }}")
                $('#process_brand').val(
                    "{{ $completePc->parts()->where('key', 'process_brand')->value('value') }}")
                $('#graphics_card_name').val(
                    "{{ $completePc->parts()->where('key', 'graphics_card_name')->value('value') }}");
                $('#graphics_card_brand').val(
                    "{{ $completePc->parts()->where('key', 'graphics_card_brand')->value('value') }}");
                $('#graphics_card_memory').val(
                    "{{ $completePc->parts()->where('key', 'graphics_card_memory')->value('value') }}");
                $('#graphics_card_condition').val(
                    "{{ $completePc->parts()->where('key', 'graphics_card_condition')->value('value') }}");
                $('#motherboard_name').val(
                    "{{ $completePc->parts()->where('key', 'motherboard_name')->value('value') }}");
                $('#motherboard_brand').val(
                    "{{ $completePc->parts()->where('key', 'motherboard_brand')->value('value') }}");
                $('#motherboard_condition').val(
                    "{{ $completePc->parts()->where('key', 'motherboard_condition')->value('value') }}");
                $('#ram_name').val("{{ $completePc->parts()->where('key', 'ram_name')->value('value') }}");
                $('#ram_brand').val("{{ $completePc->parts()->where('key', 'ram_brand')->value('value') }}");
                $('#ram_memory').val("{{ $completePc->parts()->where('key', 'ram_memory')->value('value') }}");
                $('#ram_dimm').val("{{ $completePc->parts()->where('key', 'ram_dimm')->value('value') }}");
